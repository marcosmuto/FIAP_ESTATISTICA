...
print("Modelo com regressão linear aplicada sobre o modelo com atributos gerados pelo PCA - treinamento")
...
print("Modelo com regressão linear aplicada sobre o modelo com atributos gerados pelo PCA - teste")
...
print("Modelo de regressão linear aplicada sobre o modelo com todos os atributos - treinamento")
...
print("Modelo de regressão linear aplicada sobre o modelo com todos os atributos - teste")
...
confusionMatrix(factor(treinamento_comPCA$quality), predict(modelo_Valor_tree_class0, type = 'class'))
```
...
confusionMatrix(factor(treinamento_semPCA$quality), predict(modelo_Valor_tree_class1, type = 'class'))
```
...
confusionMatrix(factor(treinamento_comPCA$quality), predict(modelo_logistica0))
```
...
confusionMatrix(factor(treinamento_semPCA$quality), predict(modelo_logistica1))
