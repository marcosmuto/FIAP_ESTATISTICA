...
A seguir será utilizado um algoritmo não supervisionado na base para agrupamento das amostras.
Para isso, foi utilizado o k-means com 7 clusters, sendo que cada cluster tentará representar um indice de qualidade (3 a 9 na base).
Além disso, para o treinamento do modelo, não foi utilizada a variável quality.
...
Observando a quantidade de amostras em cada cluster, verifica-se que há uma grande discrepância de números com relação as amostras por qualidade.
Sendo assim, o uso do k-means não é recomendado na tentativa de agrupar as amostras pela qualidade.